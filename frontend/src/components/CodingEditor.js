    ...
    <div className="h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex-1 flex overflow-hidden">
              ...
              <div className="space-y-4">
                ...
                {testResults.length > 0 ? (
                  testResults.map((result, index) => (
                    <div key={index} className={`p-4 rounded-lg border ${result.passed ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200'
                      }`}>
        ...
        <div className="w-1/2 flex flex-col">
          {/* Editor Header */}
          <div className="bg-gray-100 border-b border-gray-200 px-4 py-2 flex items-center justify-between flex-none">
          ...
          <div className="flex-1 overflow-auto bg-white">
            <Editor
              ...
              highlight={code => highlight(code, languages.java || languages.javascript)}
              padding={20}
              style={{
