...
const TakeQuiz = () => {
    ...
    // Enter fullscreen when quiz is started and not completed
    useEffect(() => {
        if (quizStarted && !quizCompleted && !showResults) {
            // Fullscreen is already entered via button click
        }

        // Exit fullscreen when component unmounts or quiz is completed
        return () => {
            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center p-4">
                <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 max-w-2xl w-full">
                    <div className="text-center">
                        ...
                        <p className="text-blue-200 text-lg mb-6">Ready to test your knowledge?</p>
                        ...
                        <div className="bg-yellow-500/20 border border-yellow-500/50 rounded-xl p-4 mb-6">
                            <p className="text-yellow-100 text-sm">
                                ⚠️ When you click "Start Quiz", your browser will enter fullscreen mode.
