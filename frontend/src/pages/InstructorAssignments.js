                                        ...
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1">
                                                <div className="flex items-center space-x-3 mb-2">
                                                    ...
                                                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${assignment.published
                                            ...
                                            <div className="flex items-center space-x-2 ml-4">
                                                <button
                                                    ...
                                                    className={`px-4 py-2 rounded-lg font-medium transition-all duration-200 ${assignment.published
