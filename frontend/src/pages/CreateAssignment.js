        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 mb-8">
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <button
                onClick={() => setMode('ai')}
                className={`p-4 rounded-lg border-2 transition-colors ${mode === 'ai'
              ...
              <button
                ...
                className={`p-4 rounded-lg border-2 transition-colors ${mode === 'codeforces'
                    ? 'border-blue-500 bg-blue-50'
                    : 'border-gray-200 hover:border-gray-300'
                  }`}
              >
              ...
              <button
                ...
                className={`p-4 rounded-lg border-2 transition-colors ${mode === 'manual'
                    ? 'border-blue-500 bg-blue-50'
                    : 'border-gray-200 hover:border-gray-300'
                  }`}
              >
