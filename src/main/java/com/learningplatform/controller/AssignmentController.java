...
public class AssignmentController {
    ...
    public ResponseEntity<List<Assignment>> getAssignmentsByCourse(@PathVariable String courseId,
        ...
        try {
            ...
            // If user is instructor and owns the course, show all assignments (published
            // and unpublished)
    ...
    public ResponseEntity<?> generateCodingAssignment(@RequestBody GenerateAssignmentRequest request,
        ...
        try {
            ...
            return ResponseEntity.badRequest()
                    .body(Map.of("error", "Failed to generate assignment: " + e.getMessage()));
        }
    }
    ...
    public ResponseEntity<?> submitAssignment(@PathVariable Long id,
        ...
        try {
            ...
            return ResponseEntity.ok(Map.of(
                    ...
                    "message", submission.isPassed() ? "Great job! Assignment completed successfully!"
    ...
    private int calculateScore(Assignment assignment, AssignmentSubmissionRequest request) {
        // Simple scoring logic - in production, this would involve code execution and
        // testing
    ...
    public static class AssignmentCreateRequest {
        ...
        public Assignment.Difficulty getDifficulty() {
            return difficulty;
        }

        public void setDifficulty(Assignment.Difficulty difficulty) {
    ...
    public static class AssignmentSubmissionRequest {
        ...
        public java.util.List<Boolean> getTestResults() {
            return testResults;
        }

        public void setTestResults(java.util.List<Boolean> testResults) {
    ...
    public ResponseEntity<?> getAvailableCodeforcesProblems(
        ...
        try {
            List<Map<String, Object>> problems = assignmentService.getAvailableCodeforcesProblems(difficulty, topic,
                    limit);
    ...
    @PreAuthorize("hasRole('INSTRUCTOR') or hasRole('ADMIN')")
    public ResponseEntity<?> createSkippedAssignment(@RequestBody Map<String, Object> request,
            HttpServletRequest httpRequest) {
        try {
            String instructorId = (String) httpRequest.getAttribute("userId");
